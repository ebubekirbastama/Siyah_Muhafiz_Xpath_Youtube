...
for (var i = 0; i < $x("//a[@class='yt-simple-endpoint style-scope ytd-grid-video-renderer']").length; i++) 
{
  syhmhz.push($x("//a[@class='yt-simple-endpoint style-scope ytd-grid-video-renderer']")[i].getAttribute('href'));
}
